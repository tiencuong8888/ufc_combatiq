...
if st.button("Predict Winner"):
    ...
    if response.status_code == 200:
        ...
        st.markdown(f"<b><span style='color: white; background-color:black; font-size: 30px'>The predicted winner is: {fight_outcome}</span></b>", unsafe_allow_html=True)
        st.markdown(f"<b><span style='color: white; background-color:black;font-size: 30px'>Win rate: {win_rate}</span></b>", unsafe_allow_html=True)
    else:
