...
if st.button("Predict Winner"):
    ...
    if response.status_code == 200:
        ...
        #st.write(f"<b><span style='color:white;'>The predicted winner is:</span></b> {fight_outcome}", unsafe_allow_html=True)
        #st.write(f"<b><span style='color:white;'>Win rate:</span></b> {win_rate}", unsafe_allow_html=True)
